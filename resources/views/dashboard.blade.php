            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="{{ url('/') }}"
                        ...
                        @if (auth()->check())
                            <a href="{{ route('chat') }}">
                                <svg style="margin-top:15px" width="35px" height="35px" viewBox="0 0 1024 1024"
                                    class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ url('dashboard') }}">Your donations</a>
                                    </li>
                        ...
                        @if ($count > 0)
                            <div class="container">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($test as $donation)
                                            <tr>
                                                <td>{{ $donation->donation->name }}

                                                    @if ($donation->total == null)
                                                        <b>&nbsp; (Food Donation)</b>
                                                    @endif
                                                </td>
                                ...
                                <a href="{{ route('certificate.download') }}"
                                    style="background-color: #5bc1ac; border: none;" class="btn btn-primary">Download
                                    Your Donation</a>
                                <br><br>
                            </div>
                        @else
